...
{
    private DatePolicy $policy;

    protected function setUp(): void
    {
        $this->policy = new DatePolicy('/destination');
    }
    ...
    public function testOrganizeImage(): void
    {
        ...
        $this->assertEquals('/destination/2021/09/image.jpg', $path->getPath());
    }
    ...
    public function testOrganizeVideo(): void
    {
        ...
        $this->assertEquals('/destination/2021/10/video.mp4', $path->getPath());
    }
    ...
    public function testOrganizeWithSingleDigitMonth(): void
    {
        ...
        $this->assertEquals('/destination/2021/01/image.jpg', $path->getPath());
    }
