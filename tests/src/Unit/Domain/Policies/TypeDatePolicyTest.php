...
final class TypeDatePolicyTest extends TestCase
{
    private TypeDatePolicy $policy;

    protected function setUp(): void
    {
        $this->policy = new TypeDatePolicy('/destination');
    }
    ...
    public function testOrganizeImage(): void
    {
        ...
        $this->assertEquals('/destination/images/2021/09/image.jpg', $path->getPath());
    }
    ...
    public function testOrganizeVideo(): void
    {
        ...
        $this->assertEquals('/destination/video/2021/10/video.mp4', $path->getPath());
    }
    ...
    public function testOrganizeAudio(): void
    {
        ...
        $this->assertEquals('/destination/audio/2021/11/audio.mp3', $path->getPath());
    }
    ...
    public function testOrganizeWithSingleDigitMonth(): void
    {
        ...
        $this->assertEquals('/destination/images/2021/01/image.jpg', $path->getPath());
    }
