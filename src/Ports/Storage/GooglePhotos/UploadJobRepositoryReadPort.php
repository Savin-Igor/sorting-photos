...
/**
 * Read-only interface for UploadJob repository.
 * Separates read operations from write operations following Interface Segregation Principle.
 */
interface UploadJobRepositoryReadPort
{
